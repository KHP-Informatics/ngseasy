...
java -Xmx${gatk_java_mem}g -Djava.io.tmpdir=${sample_temp} -jar ${ngs_gatk}/GenomeAnalysisTK.jar -T BaseRecalibrator -R ${reference_genome_seq} -S SILENT -l ERROR \
-I ${sample_dir}/${sample_name}.novorecal.bam \
-o ${sample_dir}/${sample_name}.novorecal.recal_data.table \
-knownSites ${b37_1000G_biallelic_indels} \
-knownSites ${b37_Mills_Devine_2hit_indels_sites} \
-knownSites ${b37_1000G_omni2_5} \
-knownSites ${b37_hapmap_3_3} \
-knownSites ${b37_dbsnp_132} \
-nct 1 \
